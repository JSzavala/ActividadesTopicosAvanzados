namespace JuegoMemoria
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            tblCuadricula = new TableLayoutPanel();
            label16 = new Label();
            label15 = new Label();
            label14 = new Label();
            label13 = new Label();
            ...
            tblCuadricula.SuspendLayout();
            SuspendLayout();
            // 
            // tblCuadricula
            // 
            tblCuadricula.BackColor = Color.CornflowerBlue;
            tblCuadricula.CellBorderStyle = TableLayoutPanelCellBorderStyle.Inset;
            tblCuadricula.ColumnCount = 4;
            tblCuadricula.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25F));
            tblCuadricula.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25F));
            tblCuadricula.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25F));
            tblCuadricula.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25F));
            tblCuadricula.Controls.Add(label16, 3, 3);
            tblCuadricula.Controls.Add(label15, 2, 3);
            tblCuadricula.Controls.Add(label14, 1, 3);
            tblCuadricula.Controls.Add(label13, 0, 3);
            tblCuadricula.Controls.Add(label12, 3, 2);
            tblCuadricula.Controls.Add(label11, 2, 2);
            tblCuadricula.Controls.Add(label10, 1, 2);
            tblCuadricula.Controls.Add(label9, 0, 2);
            tblCuadricula.Controls.Add(label8, 3, 1);
            tblCuadricula.Controls.Add(label7, 2, 1);
            tblCuadricula.Controls.Add(label5, 1, 1);
            tblCuadricula.Controls.Add(label4, 0, 1);
            tblCuadricula.Controls.Add(label3, 3, 0);
            tblCuadricula.Controls.Add(label2, 2, 0);
            tblCuadricula.Controls.Add(label1, 1, 0);
            tblCuadricula.Controls.Add(label6, 0, 0);
            tblCuadricula.Dock = DockStyle.Fill;
            tblCuadricula.Location = new Point(0, 0);
            tblCuadricula.Name = "tblCuadricula";
            tblCuadricula.RowCount = 4;
            tblCuadricula.RowStyles.Add(new RowStyle(SizeType.Percent, 25F));
            tblCuadricula.RowStyles.Add(new RowStyle(SizeType.Percent, 25F));
            tblCuadricula.RowStyles.Add(new RowStyle(SizeType.Percent, 25F));
            tblCuadricula.RowStyles.Add(new RowStyle(SizeType.Percent, 25F));
            tblCuadricula.Size = new Size(534, 511);
            tblCuadricula.TabIndex = 0;
            // 
            // label16
            // 
            ...
            label5.Location = new Point(138, 129);
            label5.Name = "label5";
            ...
            label2.Location = new Point(271, 2);
            label2.Name = "label2";
            ...
            Controls.Add(tblCuadricula);
            Name = "Form1";
            Text = "Matching Game";
            tblCuadricula.ResumeLayout(false);
            ResumeLayout(false);
        }

        #endregion

        private TableLayoutPanel tblCuadricula;
